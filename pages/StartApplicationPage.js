...
export class StartApplicationPage extends BasePage {
  constructor(page) {
    super(page);
    this.startApplicationText = page.locator("//div[@class='step-title' and text()='Start Application']");
    this.paymentPlanText = page.locator("//div[@class='step-title' and text()='Payment plan']");
    this.reviewText = page.locator("//div[@class='step-title' and text()='Review']");
    this.startApplicationStepCircle = page.locator("//div[@class='step-circle'][span[text()='1']]");
    this.paymentPlanStepCircle = page.locator("//div[@class='step-circle'][span[text()='2']]");
    this.reviewStepCircle = page.locator("//div[@class='step-circle'][span[text()='3']]");
    ...
    this.footer = page.locator("(//p[@class = 'footer-text' and contains(text(), 'Need help?')])[1]");
