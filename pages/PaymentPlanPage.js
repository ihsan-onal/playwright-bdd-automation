...
export class PaymentPlanPage extends BasePage {
  constructor(page) {
    ...
    this.upfrontPaymentOption = page.locator("//span[@class='payment-type'][contains(text(),'Upfront')]");
    ...
    this.couponBoxCloseBtnX = page.locator("//span[@class='mat-ripple mat-mdc-button-ripple']");
    ...
    this.step1Parent = page.locator("(//div[contains(@class,'step ng-star-inserted')])[1]");
    this.step2Parent = page.locator("(//div[contains(@class,'step ng-star-inserted')])[2]");
    this.step3Parent = page.locator("(//div[contains(@class,'step ng-star-inserted')])[3]");
